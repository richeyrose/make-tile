...
def create_displacement_object(obj):
    ...
    '''
    # add subsurf modifier
    preview_obj_subsurf = preview_obj.modifiers.new('Subsurf', 'SUBSURF')
    preview_obj_subsurf.subdivision_type = 'SIMPLE'
    preview_obj_subsurf.levels = 0
    preview_obj['subsurf_mod_name'] = preview_obj_subsurf.name
    preview_obj['preview_materials'] = {}
